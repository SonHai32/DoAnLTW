    ...
    <div class="header flex flex-row align-items space-between">
        ...
        <div class="nav flex justify-center align-center">
            <ul class='list-items flex flex-row list-style-none space-around align-center'>
                <li class='nav-item-trang-chu'><a href="/Website/Default.aspx">Trang chủ</a></li>
                <li class='nav-item-san-pham'><a href="/Website/Default.aspx">Sản phẩm</a></li>
                <li class='nav-item-khuyen-mai'><a href="/Website/Default.aspx?Sale=true">Khuyến mãi</a></li>
                <li class='nav-item-gioi-thieu'><a href="/Website/AboutUs.aspx">Giới thiệu</a></li>
            </ul>
        </div>
